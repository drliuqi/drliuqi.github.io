...
4) 本科毕业设计论文  
* 《基于电磁辐射的人工智能驱动显示信息重建》（邓恺琪，2026）
* 《自由视角与任意姿态下的三维人体位姿重建研究》（汪思佟，2026）
* 《基于大语言模型的图像生成与编辑智能体设计与实现》（霍君安，2026）
* 《基于智能体的运动医学研究》（钟睿，2026）
* 《可注入风格的统一骨骼重定向》（王子寒，2026）
* 《强化学习驱动的视觉生成质量优化研究》（叶子绿，2026）
* 《基于多模态模型的篮球比赛图像智能解说系统研究》（曾嘉，2026）
* 《基于抽象全局表征辅助的多模态极端视角位姿设计》（孙振宇，2026）
* 《人声分离语音转写系统的设计与实现》（谢金璇，2026）
* 《融合决策树与大语言模型的高可靠高解释智能医学咨询系统研究》（陈博灵，2026）
* 《人声分离扩声系统的设计与实现》（井可欣，2026）
