...
* 《人声分离扩声系统的设计与实现》（井可欣）
* 《物理驱动的3D场景交互与仿真研究》（吴锡杰）

2025年：     
* 《在线环境下多模态大语言模型的强化学习算法研究》（朱小烨）  
* 《基于人类偏好对齐的视觉内容生成方法研究》（李天骋）【<span style='color:red'>优秀毕业论文</span>，**院级**】    
* 《基于全监督学习的端到端多任务人—物接触关系检测技术研究》（蒋新宇）【<span style='color:red'>优秀毕业论文</span>，**院级**】  
* 《基于视频无监督域自适应的对抗鲁棒算法研究》（高孟熙）  
* 《符号音乐生成系统设计与实现》（吕锐坚）  
* 《基于扩散模型的多模态驱动场景视频生成方法研究》（刘锦绣）【<span style='color:red'>优秀毕业论文</span>，**院级和校级**】  
